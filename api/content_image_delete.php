...
try {
    ...
    if ($linksCount > 0) {
        jsonResponse(['ok' => false, 'error' => 'Изображение используется в других контентах и не может быть удалено'], 409);
    }
    ...
    $dir = $root . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR . 'content_images';
