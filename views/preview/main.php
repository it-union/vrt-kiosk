...
<head>
    ...
    <style>
        html, body { margin: 0; width: 100%; height: 100%; overflow: hidden; font-family: Tahoma, sans-serif; background: #334155; color: #1a1a1a; -webkit-text-size-adjust: 100%; text-size-adjust: 100%; }
...
function createScheduleRenderNode(rawData) {
    ...
    if (window.ScheduleRenderer && typeof window.ScheduleRenderer.render === 'function') {
        return window.ScheduleRenderer.render({ schedule, theme, mode: 'preview' });
    }
